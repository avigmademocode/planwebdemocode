HomeApp.controller('AddProductCategoryController', ['$scope', '$window', 'NewRequestFactory', 'AddProductCategoryFactory', function ($scope, $window, NewRequestFactory, AddProductCategoryFactory) {
    ...
    $scope.GetProductCategoryDetails = function (CustID) {
        ...
        AddProductCategoryFactory.GetProdCategryData(CustID)
            .then(function (response) {
    ...
    $scope.SaveProductCatgry = function (ProductCatgryList) {
        debugger;
        var ProdCatgrylist =
            {
        ...
        AddProductCategoryFactory.SaveProductCategryData(ProdCatgrylist)
            .then(function (response) {
                if (response.data.length > 0) {
                    //debugger;
                    $scope.ProductCategories = response.data[0];
