    ...
    public class UserMasterData
    {
               ...
               UserMaster newUserMaster)
        {
            ...
            if (newUserMaster.Locked == true) {
                updateCommand.Parameters.AddWithValue("@NewLocked", newUserMaster.Locked);
            } else {
                updateCommand.Parameters.AddWithValue("@NewLocked", DBNull.Value); }
            if (newUserMaster.IsActive == true) {
                updateCommand.Parameters.AddWithValue("@NewIsActive", newUserMaster.IsActive);
            } else {
            ...
            if (oldUserMaster.Locked == true) {
                updateCommand.Parameters.AddWithValue("@OldLocked", oldUserMaster.Locked);
            } else {
                updateCommand.Parameters.AddWithValue("@OldLocked", DBNull.Value); }
            if (oldUserMaster.IsActive == true) {
                updateCommand.Parameters.AddWithValue("@OldIsActive", oldUserMaster.IsActive);
            } else {
